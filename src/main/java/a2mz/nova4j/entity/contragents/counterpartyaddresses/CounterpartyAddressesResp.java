...
import a2mz.nova4j.entity.contragents.contactpersons.ContactPerson;
...
public class CounterpartyAddressesResp {
	...
	public CounterpartyAddressesResp withSuccess(Boolean success) {
		this.success = success;
		return this;
	}
	...
	public CounterpartyAddressesResp withData(List<ContactPerson> data) {
		this.data = data;
		return this;
	}
	...
	public CounterpartyAddressesResp withErrors(List<Object> errors) {
		this.errors = errors;
		return this;
	}
	...
	public CounterpartyAddressesResp withWarnings(List<Object> warnings) {
		this.warnings = warnings;
		return this;
	}
	...
	public CounterpartyAddressesResp withInfo(Info info) {
		this.info = info;
		return this;
	}
	...
	public CounterpartyAddressesResp withMessageCodes(List<Object> messageCodes) {
		this.messageCodes = messageCodes;
		return this;
	}
	...
	public CounterpartyAddressesResp withErrorCodes(List<Object> errorCodes) {
		this.errorCodes = errorCodes;
		return this;
	}
	...
	public CounterpartyAddressesResp withWarningCodes(List<Object> warningCodes) {
		this.warningCodes = warningCodes;
		return this;
	}
	...
	public CounterpartyAddressesResp withInfoCodes(List<Object> infoCodes) {
		this.infoCodes = infoCodes;
		return this;
	}
